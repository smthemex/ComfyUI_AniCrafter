...
from .smpl_x import SMPLXModel, read_smplx_param
from .smpl_x_voxel_dense_sampling import SMPLXVoxelMeshModel
from .utils.sh_utils import RGB2SH, SH2RGB
from .utils.typing import *
from .utils.utils import MLP, trunc_exp
from ..utils import LinerParameterTuner, StaticParameterTuner
from ...outputs.output import GaussianAppOutput
...
class GS3DRenderer(nn.Module):
    ...
    def forward(
        ...
        height,
        width,
        additional_features: Optional[Float] = None,#[Tensor, "B C H W"]
        background_color: Optional[Float] = None,#[Tensor, "B Nv 3"]
        debug: bool = False,
        **kwargs,
    ):
...
def test1():
    ...
    set_seed(1234)
    try:
        from ...datasets.video_human import VideoHumanDataset
    except:
        pass
