...
class ResNetArcFace(nn.Module):
    ...
    def __init__(
        ...
        layers=[2, 2, 2, 2],
        use_se=False,
        pretrain_model=f"{base_model_path}/pretrained_models/arcface_resnet18.pth",
    ):
        if block == "IRBlock":
            block = IRBlock
        self.inplanes = 64
    ...
    def load_network(net, load_path, strict=True, param_key=None):
        ...
        load_net = torch.load(load_path,weights_only=False, map_location=lambda storage, loc: storage)
