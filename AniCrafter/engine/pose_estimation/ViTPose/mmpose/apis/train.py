...
from ..core import DistEvalHook, EvalHook, build_optimizers
from ..core.distributed_wrapper import DistributedDataParallelWrapper
...
try:
    ...
    from ..core import Fp16OptimizerHook
...
def train_model(model,
    ...
    if distributed:
        ...
        if mmcv.__version__ >= '1.4.4' or torch.cuda.is_available():
